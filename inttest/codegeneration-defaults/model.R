        ...
        }
        {
            ...
            for (age in seq(fish__minage, fish__maxage, by = 1)) {
                ...
                if (area == comm__area) {
                  ...
                  fish_comm__cons[, fish__area_idx, fish__age_idx] <- ((if (area != 1L) 
                    0
                  else intlookup_getdefault(comm_landings, cur_year, 0)) * (fish_comm__suit[, fish__area_idx, fish__age_idx]/total_predsuit)) * fish__wgt[, fish__area_idx, fish__age_idx]
                }
            }
